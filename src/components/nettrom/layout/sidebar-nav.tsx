      ...
      subItems: [
        {
          ...
          active:
            pathname === Constants.Routes.nettrom.search ||
            pathname?.startsWith(Constants.Routes.nettrom.search),
        },
        {
          ...
          active:
            ...
            pathname?.startsWith("/recently-added"),
        },
        {
  ...
  return (
    <>
      ...
      <aside
        ref={sidebarRef}
        className={twMerge(
          "fixed left-0 top-0 z-[60] flex h-screen flex-col bg-neutral-800 transition-all duration-300",
          isOpen ? "w-96" : "w-0 overflow-hidden",
        )}
      >
        {/* Logo/Brand Header - Chỉ hiển thị khi sidebar mở */}
        {isOpen && (
          <div className="pointer-events-auto flex items-center justify-between px-12 pb-5 pt-5">
            <Link
              href={Constants.Routes.nettrom.index}
              className="flex items-center gap-3 text-white no-underline transition-colors hover:text-orange-500"
            >
            ...
            <button
              ...
              className="cursor-pointer rounded-lg p-2 text-neutral-400 transition-colors hover:bg-neutral-700 hover:text-white"
        ...
        {/* Navigation */}
        <nav className="pointer-events-auto flex-1 overflow-y-auto py-2">
              ...
              return (
                <li key={item.title}>
                  <Link
                    href={item.href || "#"}
                    className={twMerge(
                      "flex items-center gap-3 rounded-lg px-4 py-2 text-3xl font-semibold no-underline transition-colors",
                      isActive
        ...
        {isOpen && (
          <div className="pointer-events-auto mt-auto border-t border-neutral-700 p-4">
            {/* Social Links */}
            ...
            <div className="space-y-1 text-center">
              ...
              <Link
                href="#"
                className="text-xl text-neutral-400 no-underline transition-colors hover:text-white"
              >
                Terms & Policies
              </Link>
            </div>
