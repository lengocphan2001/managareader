...
export default function RecentlyAddedSlider() {
  ...
  useEffect(() => {
    if (recentlyAddedManga.length > 0) addMangas(recentlyAddedManga);
  }, [recentlyAddedManga, addMangas]);
  ...
  return (
    <div className="px-2 py-3 sm:px-4 sm:py-4 md:px-6 md:py-6 lg:px-24 lg:py-12">
      ...
      <Swiper
        modules={[Autoplay]}
        loop={recentlyAddedManga.length > 10}
